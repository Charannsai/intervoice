      ...
      <div className="min-h-screen bg-black flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-lg p-8 text-center">
          ...
          <div className="mb-6 flex flex-col items-center">
            <span className={`text-4xl font-bold mb-2 ${passed ? 'text-white' : 'text-red-400'}`}>
              {roundScore}%
            </span>
          ...
          <div className="bg-black border border-zinc-800 rounded-lg p-4 mb-8 text-left">
      ...
      <div className="border-b border-zinc-800 bg-black/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <span className="text-sm font-semibold text-zinc-400">Round {roundIndex + 1}/{session.rounds.length}</span>
