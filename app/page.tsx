    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white selection:bg-zinc-200 dark:selection:bg-zinc-800">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-blue-600 dark:text-blue-400">interview process.</span>
            </motion.h1>
            ...
            >
              ...
              <button 
                onClick={handleGetStarted}
                className="px-6 py-2.5 bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 text-black dark:text-white hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors rounded-md font-medium text-sm min-w-[140px]"
              >
                View Demo
              </button>
            </motion.div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black p-8 rounded-2xl">
              ...
              <p className="text-zinc-500 text-sm mb-6">Our engine parses your PDF to generate questions relevant to your actual experience level and tech stack.</p>
            ...
            <div className="grid grid-rows-2 gap-8">
              ...
              <div className="border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black p-8 rounded-2xl flex flex-col justify-center relative overflow-hidden h-full">
                 <div className="absolute -top-4 -right-4 p-4 opacity-5">
                   <Code className="w-48 h-48" />
                 </div>
                 <div className="relative z-10">
                   <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-4">Top Rubrics</div>
                   <h3 className="text-2xl font-bold mb-2">Global Standards</h3>
                   <p className="text-zinc-500 text-sm">Calibrated against top tech rubrics. Feel prepared for FAANG-level interviews.</p>
                 </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 px-6 border-t border-zinc-100 dark:border-zinc-900 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-12 sm:gap-16 opacity-80 dark:opacity-70">
            {['Google', 'Meta', 'Netflix', 'Uber', 'Stripe'].map((company) => (
              <span key={company} className="text-xl font-bold text-zinc-800 dark:text-zinc-200 pointer-events-none hover:text-black dark:hover:text-white transition-colors cursor-default">{company}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 py-8 bg-zinc-50 dark:bg-black">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 bg-black dark:bg-white rounded-md flex items-center justify-center">
              <span className="font-bold text-white dark:text-black text-xs leading-none">I</span>
            </div>
          ...
          <div className="flex gap-6">
            <a href="/terms" className="text-zinc-500 hover:text-black dark:hover:text-white transition-colors text-xs">Terms</a>
            <a href="/privacy" className="text-zinc-500 hover:text-black dark:hover:text-white transition-colors text-xs">Privacy</a>
          </div>
        </div>
      </footer>
    </div>
