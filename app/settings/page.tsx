  ...
  return (
    <div className="max-w-xl">
      ...
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-medium text-zinc-600 dark:text-zinc-400 mb-2">Interview Difficulty Level</label>
          <select className="w-full bg-white dark:bg-black border border-zinc-300 dark:border-zinc-700 rounded-lg px-4 py-2 text-black dark:text-white focus:outline-none focus:border-zinc-500 transition-colors">
